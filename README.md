...
Логика работы на данный момент такова:
 - при получении сообщения от меги:
    ...
    - вернуть меге комманду, определяемую в конфигурационном файле:
       - комманду, настроенную на ней самой (параметр "response_mode"="device", значение по умолчанию)
...
## Параметры командной строки
  ...
  - **--config <имя файла>** - Имя конфигурационного файла. Значение по умолчанию *megad-mqtt-gw.json*
  - **--log <имя файла>** - имя журнального файла. Значение по умолчанию *<каталог скрипта>/log/megad-mqtt-gw.log*
